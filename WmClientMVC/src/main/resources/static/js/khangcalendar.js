...
function appendDay(day, calendarDaysElement) {
    ...
    dayLink.href = "/customers/order/getvenue";
//ajax
    ...
    dayLink.addEventListener("click", function (event) {
        ...
        xhr.open("POST", "/customers/order/getvenue");
...
// Loop through the buttons and attach an event listener to each one
    buttons.forEach(button => {
        button.addEventListener('click', function (event) {
            ...
            xhr.open('POST', '/customers/order/create');
            ...
            xhr.onload = function () {
                ...
                if (xhr.status === 200) {
                    ...
                    form.method = "POST";
                    form.action = "/customers/order/create-detail";
