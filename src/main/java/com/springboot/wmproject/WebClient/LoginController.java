package com.springboot.wmproject.WebClient;
...
import static com.springboot.wmproject.utils.SD.DOMAIN_APP;

@Controller
public class LoginController {
    String customerLoginUrl = DOMAIN_APP + "/api/auth/customer/login";
    String employeeLoginUrl = DOMAIN_APP + "/api/auth/employee/login";
